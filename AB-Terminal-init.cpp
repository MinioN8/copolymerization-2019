/*****************************************************************************************
	...
	**This is a fork of the code used in the 2019 paper. This code initiates the A and 
	B-terminal polymer chains with their stead-state values to see if the copolymer 
	equation accuracy can be recovered in the limit of 0% conversion
	
	g++ -I/Users/nl7597/Documents/Calculations/Eigen -O3 -msse3 -o rr AB-Terminal-init.cpp
...
int main(int argc, char* argv[])
{
	...
	//ystart[3] = 0.; // XA(0)
	//ystart[4] = 0.; // XB(0)
	ystart[3] = kBA*I0*A0/(kBA*A0+kAB*B0); // XA(0)
	ystart[4] = kAB*I0*B0/(kAB*B0+kBA*A0); // XB(0)
	// need to adjust the I0, A0, & B0 to account for chain initiation
	ystart[0] = I0 - ystart[3] - ystart[4]; // I(0)
	ystart[1] = A0 - ystart[3]; // A(0)
	ystart[2] = B0 - ystart[4]; // B(0)
